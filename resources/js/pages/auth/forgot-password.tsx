            ...
            <div className="w-full max-w-md space-y-8">
                <div className="flex flex-col items-center gap-6 text-center">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <h1 className="bg-gradient-to-r from-violet-500 to-purple-600 bg-clip-text text-2xl font-bold text-transparent">
                            Forgot Password?
                        </h1>
                    </div>
                    <p className="max-w-sm text-sm text-gray-500">No worries! Enter your email and we'll send you a link to reset your password.</p>
                </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="pl-10"
                            />
                            <Mail className="absolute top-2.5 left-3 h-5 w-5 text-gray-500" />
                        </div>
                ...
                <div className="text-center text-sm text-gray-500">
                    ...
                    <TextLink href={route('login')} className="hover:text-violet-600">
                        Log in
                    </TextLink>
                </div>
            </div>
