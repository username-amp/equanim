...
function MeditationCard({ item }: { item: MeditationItem }) {
    return (
        <Link href={route('meditate.details', item.id)} className="block">
            <Card className="group relative overflow-hidden rounded-2xl bg-black/5 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:bg-purple-500/10 hover:ring-2 hover:ring-purple-400/50 hover:ring-offset-4 dark:hover:bg-purple-500/20">
                <div className="aspect-video w-full overflow-hidden">
                    {item.image_url ? (
                        ...
                        <div className="flex h-full items-center justify-center bg-gradient-to-br from-purple-400/30 via-violet-500/20 to-fuchsia-400/30">
                            <Flower2 className="h-12 w-12 animate-pulse text-purple-400" />
                        </div>
                    )}
                </div>
    ...
    return (
        <div className="flex h-[60vh] flex-col items-center justify-center text-center">
            <div className="relative mb-6">
                <div className="absolute inset-0 animate-[pulse_3s_ease-in-out_infinite] rounded-full bg-purple-400/30 blur-2xl" />
                <div className="relative rounded-full bg-gradient-to-br from-purple-400 via-fuchsia-500 to-violet-600 p-4 shadow-lg shadow-purple-500/50">
                    <Sparkles className="h-12 w-12 animate-[bounce_2s_ease-in-out_infinite] text-white" />
                </div>
            </div>
            ...
            <div className="flex space-x-4">
                <div className="h-2 w-2 animate-[bounce_1s_ease-in-out_infinite] rounded-full bg-gradient-to-r from-purple-400 to-fuchsia-500 shadow-lg shadow-purple-500/50 [animation-delay:-0.3s]" />
                <div className="h-2 w-2 animate-[bounce_1s_ease-in-out_infinite] rounded-full bg-gradient-to-r from-fuchsia-500 to-violet-600 shadow-lg shadow-purple-500/50 [animation-delay:-0.15s]" />
                <div className="h-2 w-2 animate-[bounce_1s_ease-in-out_infinite] rounded-full bg-gradient-to-r from-violet-600 to-purple-400 shadow-lg shadow-purple-500/50" />
            </div>
        </div>
    );
}
        ...
        <AppLayout>
            ...
            <ScrollArea className="h-[calc(100vh-8rem)]">
                <div className="space-y-8 pb-20">
                    {/* Hero Section */}
                    <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-400 via-fuchsia-500 to-violet-600 p-8 text-white shadow-lg shadow-purple-500/50 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/50">
                        ...
                        <div className="absolute bottom-0 left-0 h-32 w-32 -translate-x-1/2 translate-y-1/2 rounded-full bg-violet-300/20 blur-2xl" />
                    </section>
                        ...
                        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-400 via-fuchsia-500 to-violet-600 p-8 text-white shadow-lg shadow-purple-500/50 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/50">
                            <div className="relative z-10">
                                <div className="mb-6 flex items-center gap-3">
                                    <div className="rounded-full bg-gradient-to-br from-purple-400/30 to-fuchsia-500/30 p-2 backdrop-blur-md">
                                        <Moon className="h-6 w-6 animate-pulse text-purple-400" />
                                    </div>
                                    <div>
                    ...
                    {todaysMeditation && (
                        <section className="relative">
                            <div className="mb-6 flex items-center gap-3">
                                <div className="rounded-full bg-gradient-to-br from-purple-400/30 to-fuchsia-500/30 p-2 backdrop-blur-md">
                                    <Sun className="h-6 w-6 animate-pulse text-purple-400" />
                                </div>
                                <div>
                    ...
                    {sections.map((section) => (
                        <section key={section.title} className="relative">
                            <div className="mb-6 flex items-center gap-3">
                                <div className="rounded-full bg-gradient-to-br from-purple-400/30 to-fuchsia-500/30 p-2 backdrop-blur-md">
                                    <Flower2 className="h-6 w-6 animate-pulse text-purple-400" />
                                </div>
                                <div>
