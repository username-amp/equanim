                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            variant="ghost"
                            size="icon"
                            className={cn('hover:bg-purple-500/10 hover:text-purple-400', isLooping && 'text-purple-400 bg-purple-500/10')}
...
function FocusItem({
    ...
    return (
        <Link
            ...
            className="group relative aspect-square overflow-hidden rounded-2xl bg-black/5 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:bg-purple-500/5 hover:ring-2 hover:ring-purple-400/50 hover:ring-offset-4 dark:hover:bg-purple-500/10"
        >
            ...
            <div className="absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 transform">
                <Button
                    size="icon"
                    className="h-16 w-16 rounded-full bg-gradient-to-br from-purple-400/80 to-violet-600/80 opacity-0 backdrop-blur-md transition-all group-hover:opacity-100 hover:scale-110 hover:bg-white/30 hover:shadow-lg hover:shadow-purple-500/50"
                >
    ...
    return (
        <div className="flex h-[60vh] flex-col items-center justify-center text-center">
            <div className="relative mb-6">
                ...
                <div className="relative rounded-full bg-gradient-to-br from-purple-400 to-violet-600 p-4 shadow-lg shadow-purple-500/50">
                    <Music className="h-12 w-12 text-white" />
                </div>
            </div>
            <h2 className="mb-2 text-2xl font-semibold bg-gradient-to-br from-purple-400 to-violet-600 bg-clip-text text-transparent">Finding Your Focus...</h2>
                    ...
                    <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-400 via-fuchsia-500 to-violet-600 p-8 text-white shadow-lg shadow-purple-500/50 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/50">
                        <div className="relative z-10">
                            <div className="mb-4 inline-flex rounded-full bg-white/20 px-4 py-2 backdrop-blur-md">
                                <Music className="mr-2 h-5 w-5 animate-pulse text-violet-200" />
                                <span className="text-sm font-medium">Focus Mode ✨</span>
                            </div>
                            <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">Enhance Your Focus</h1>
                            <p className="mt-2 text-lg text-white/90">Immerse yourself in curated ambient sounds for deep concentration</p>
