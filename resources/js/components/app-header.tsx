        ...
        >
            <div className="mx-auto flex h-16 items-center justify-between px-4 md:max-w-7xl">
                ...
                <Link href="/dashboard" prefetch className="group flex items-center gap-2 transition-transform hover:scale-[0.98]">
                    ...
                    <span className="bg-gradient-to-r from-purple-500 to-violet-600 bg-clip-text text-lg font-semibold text-transparent">
                        Equanim
                    </span>
                </Link>
                        ...
                        return (
                            ...
                            >
                                <Link href={item.href}>
                                    ...
                                    {isActive && (
                                        <span
                                            className="absolute bottom-0 left-0 h-0.5 w-full bg-gradient-to-r from-purple-500 to-violet-600"
                                            style={{
                                                transform: 'scaleX(1)',
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {auth.user.role === 'admin' && (
                        <Button
                            variant="ghost"
                            size="sm"
                            className="hidden items-center gap-2 transition-transform hover:scale-105 hover:text-purple-500 md:flex"
                            asChild
                        >
                            <Link href="/admin">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" className="group relative size-10 rounded-full p-1 transition-transform hover:scale-105">
                                <div className="relative">
                                    <Avatar className="size-8 overflow-hidden rounded-full ring-2 ring-purple-500/20 transition-all duration-300 group-hover:ring-purple-500/40">
